...
Prototipo funcional de la nueva web narrativa de Ynera. El scroll vertical controla un recorrido lateral donde un cliente detecta un problema, trabaja con datos e IA, protege la solución, la implementa y obtiene un resultado.
